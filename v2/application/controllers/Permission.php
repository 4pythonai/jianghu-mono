...
class Permission extends MY_Controller {
  ...
  public function getFirlstLevelMenus() {
    $sql = "select * from nanx_portal_menu_list where parent_id is NULL ORDER BY listorder";
    $res = $this->db->query($sql)->result_array();
    $ret = ['code' => 200, 'menus' => $res, 'message' => 'success'];
    echo json_encode($ret);
  }
}
