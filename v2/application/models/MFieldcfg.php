...
class MFieldcfg extends CI_Model {
    ...
    public function getAllColsCfg($datagrid_code, $base_table, $all_db_fields) {
        ...
        $cols_cfg =  $this->MFieldcfg->_sortFieldDisplayOrder($cols_cfg, $Array_display_order);
    ...
    public function getDisplayCfg($datagrid_code, $db_field) {
        ...
        $display = ['field_c' => $title, 'column_color' => $row['column_color'], 'handler' => $handler, 'show_as_pic' => "0"];
        return $display;
    }
