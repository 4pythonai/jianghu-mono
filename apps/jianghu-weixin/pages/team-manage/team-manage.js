...
Page({
  ...
  goApproveJoin() {
    wx.navigateTo({
      url: `/pages/team-approve/team-approve?teamId=${this.data.teamId}`
    })
  },
  ...
  goInviteMember() {
    wx.navigateTo({
      url: `/pages/team-invite/team-invite?teamId=${this.data.teamId}`
    })
  },
  ...
  goMemberManage() {
    wx.navigateTo({
      url: `/pages/team-members/team-members?teamId=${this.data.teamId}&mode=manage`
    })
  },
  ...
  goCreateGame() {
    wx.navigateTo({
      url: `/pages/createTeamGame/createTeamGame?teamId=${this.data.teamId}`
    })
  },
  ...
  goAdminManage() {
    wx.navigateTo({
      url: `/pages/team-admin/team-admin?teamId=${this.data.teamId}`
    })
  },
  ...
  goTransferOwner() {
    wx.navigateTo({
      url: `/pages/team-transfer/team-transfer?teamId=${this.data.teamId}`
    })
  },
  ...
  goMemberList() {
    wx.navigateTo({
      url: `/pages/team-members/team-members?teamId=${this.data.teamId}&mode=view`
    })
  },
