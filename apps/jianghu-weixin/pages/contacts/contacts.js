...
Page({
     ...
     */
    goToFollowings() {
        wx.navigateTo({ url: '/pages/contacts/followings/followings' })
    },
     ...
     */
    goToFollowers() {
        wx.navigateTo({ url: '/pages/contacts/followers/followers' })
    },
     ...
     */
    goToGhosts() {
        wx.navigateTo({ url: '/pages/contacts/ghosts/ghosts' })
    },
     ...
     */
    goToAddFriend() {
        wx.navigateTo({ url: '/pages/player-select/addPlayerHub/addPlayerHub' })
    },
    ...
    goToUserProfile(e) {
        ...
        if (friend?.userid) {
            wx.navigateTo({ url: `/pages/user-profile/user-profile?user_id=${friend.userid}` })
        }
    }
})
