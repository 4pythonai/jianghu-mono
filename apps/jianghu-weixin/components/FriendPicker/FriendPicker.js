    ...
    methods: {
        ...
        toggleFriendSelection(e) {
            ...
            if (friend.selected) {
                ...
                if (selectedFriends.length >= this.properties.maxSelect) {
                    wx.showToast({
                        title: `最多只能选择${this.properties.maxSelect}名好友`,
                        icon: 'none'
                    });
                    return;
                }
            ...
            this.setData({ groupedFriends, friends, selectedFriends });
        },
        ...
        onConfirm() {
            if (this.data.selectedFriends.length === 0) {
                wx.showToast({ title: '请至少选择一名好友', icon: 'none' });
                return;
            }

            this.triggerEvent('confirm', {
                friends: this.data.selectedFriends,
