...
) ENGINE=InnoDB AUTO_INCREMENT=1339355 DEFAULT CHARSET=utf8mb3 COMMENT='比赛表';
...
CREATE TABLE `t_game_court` (
  ...
  KEY `idx_courtid` (`courtid`)
) ENGINE=InnoDB AUTO_INCREMENT=688 DEFAULT CHARSET=utf8mb3 COMMENT='比赛半场表';
...
) ENGINE=InnoDB AUTO_INCREMENT=1194 DEFAULT CHARSET=utf8mb3 COMMENT='比赛人员表';
...
) ENGINE=InnoDB AUTO_INCREMENT=551 DEFAULT CHARSET=utf8mb3 COMMENT='比赛每洞成绩';
...
) ENGINE=InnoDB AUTO_INCREMENT=33 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='分队成员表';
...
) ENGINE=InnoDB AUTO_INCREMENT=75 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='比赛分队表（队内赛临时分队/队际赛参赛球队）';
