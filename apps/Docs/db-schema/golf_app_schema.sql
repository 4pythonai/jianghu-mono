...
) ENGINE=InnoDB AUTO_INCREMENT=1339349 DEFAULT CHARSET=utf8mb3 COMMENT='比赛表';
...
CREATE TABLE `t_game_court` (
  ...
  KEY `idx_courtid` (`courtid`)
) ENGINE=InnoDB AUTO_INCREMENT=677 DEFAULT CHARSET=utf8mb3 COMMENT='比赛半场表';
...
) ENGINE=InnoDB AUTO_INCREMENT=1177 DEFAULT CHARSET=utf8mb3 COMMENT='比赛人员表';
