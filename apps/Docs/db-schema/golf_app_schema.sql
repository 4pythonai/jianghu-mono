...
) ENGINE=InnoDB AUTO_INCREMENT=1339453 DEFAULT CHARSET=utf8mb3 COMMENT='比赛表';
...
) ENGINE=InnoDB AUTO_INCREMENT=821 DEFAULT CHARSET=utf8mb3 COMMENT='比赛半场表';
...
) ENGINE=InnoDB AUTO_INCREMENT=1559 DEFAULT CHARSET=utf8mb3 COMMENT='比赛人员表';
...
) ENGINE=InnoDB AUTO_INCREMENT=700 DEFAULT CHARSET=utf8mb3 COMMENT='比赛每洞成绩';
...
CREATE TABLE `t_game_tag_member` (
  ...
  `pay_money` double(10,2) DEFAULT NULL COMMENT '付款金额',
  PRIMARY KEY (`id`),
...
) ENGINE=InnoDB AUTO_INCREMENT=60 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='分队成员表';
...
) ENGINE=InnoDB AUTO_INCREMENT=103 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='比赛分队表（队内赛临时分队/队际赛参赛球队）';
...
) ENGINE=InnoDB AUTO_INCREMENT=25 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='球队成员表';
...
) ENGINE=InnoDB AUTO_INCREMENT=837793 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
